    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mt-[-4rem] relative">
            ...
            <p class="mt-6 text-lg text-gray-600 max-w-xl mx-auto">
                O servidor recebeu uma resposta inválida de outro serviço.
                <br class="hidden sm:inline">
                Isto costuma ser temporário. Por favor, tenta novamente dentro de instantes.
            </p>
        </div>
            ...
            >
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M4 4v6h6M20 20v-6h-6M5 19a9 9 0 0014-5"/>
                </svg>
                Tentar novamente
            </button>
