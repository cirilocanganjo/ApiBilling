...
@section('page-breadcrumb', 'Clientes / Listagem')
@section('page-title', 'Clientes - Listagem')
...
<div>
     ...
     <div id="wrapper">
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
            <x-modal-address-details :ownerAddressTitleDetail="$ownerAddressTitleDetail ?? '' "
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="flex flex-col justify-center text-center">
                                                    ...
                                                    <div wire:click="GetClientAddressDetails('{{ $client['uuid'] }}')" data-bs-target='#modal-address-details' data-bs-toggle='modal' class=" text-red-400 cursor-pointer  my-2 text-[12px]">
                                            ...
                                            <td>
                                                <div class="d-flex flex-column justify-content-center">
                                                    <span>{{ $client['stored_by_user']['name'] ?? '' }}</span>
                                                    <span class='text-blue-500 my-2'>{{date('d-m-Y H:i', strtotime($client['created_at']))}}</span>
                                                </div>
                                            </td>
                                            <td>
                                                 <div class="d-flex flex-column justify-content-center">
                                                    <span>{{ $client['updated_by_user']['name'] ?? '' }}</span>
                                                    <span class='text-blue-500 my-2'>{{date('d-m-Y H:i', strtotime($client['updated_at']))}}</span>
                                                </div>
                            ...
                            <div>
                                 ...
                                 {{ $clients instanceof \Illuminate\Pagination\LengthAwarePaginator ? $clients->links() : '' }}
                            </div>
                            <!-- End of Pagination -->
